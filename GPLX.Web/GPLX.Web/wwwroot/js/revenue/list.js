var RevenueList = function () {
    ...
    base.pageLanguage = languages.vi.revenue;
    ...
    base.searchForm = function (data) {
        if (typeof (data) !== 'undefined') {
            ...
            data.Year = typeof base.$selectYear != 'undefined' ? base.$selectYear.val() : -100;
        ...
        base.$tableDataTable = $.fn.jsTableRegister({
            ...
            columns: [
                ...
                },
                {
                    idx: 5,
                    render: function (data, type, row, meta) {
                        return costJsBase.FormatMoney(row.totalExpectRevenue, '-');
                    },
                    class: "text-center",
                    width: "10%"
                },
                {
                    idx: 6,
                    render: function (data, type, row, meta) {
                        return costJsBase.FormatMoney(row.totalNumberCustomer, '-');
                    },
                    class: "text-center",
                    width: "8%"
                },
                ...
                case "pop":
                    switch (action) {
                        ...
                        case "history":
                            ...
                            base.settingPage.fnURI('/RevenuePlan/ViewHistories?record=' + jQuery.fn.aesToParams(record.record));
