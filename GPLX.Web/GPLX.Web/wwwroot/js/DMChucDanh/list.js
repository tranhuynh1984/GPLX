var DMChucDanh = function () {
    ...
    base.pageLanguage = languages.vi.DMChucDanh;
        ...
        base.$tableDataTable = $.fn.jsTableRegister({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        let s = '';
                        s = '<a class="mr-2" href="javascript:void(0)" title="Chỉnh sửa thông tin chức danh" prop-type="elems.table.edit" prop-type-act="pop" ><i class="fad fa-pencil med-theme-primary-button"></i></a>'
                        s += '<a class="fs-17 text-info mr-2" prop-type="elems.table.info" prop-type-act="pop" title="Chi tiết chức danh" href="javascript:void(0)"><i class="fad fa-info-square"></i></a>'
                        s += '<a class="text-danger mr-2" prop-type="elems.table.delete" prop-type-act="confirm" title="Xóa chức danh" href="javascript:void(0)"><i class="fad fa-ban"></i></a>'
                        return s;
                    },
                    width: "5%",
                    class: "text-center"
    ...
    base.exportExcel = function () {
        ...
        costJsBase.ExportExcel('/DMChucDanh/ExportExcel', data);
    }
    ...
    base.bindActions = function () {
        ...
        base.$btnCreate.bind("click",
            function () {
                ...
                base.settingPage.fnURI('/DMChucDanh/Create');
    ...
    base.tabRecordFuncHandle = function () {
        ...
        if (typeof (propAct) !== 'undefined') {
            switch (propAct) {
                case "pop":
                    switch (action) {
                        ...
                        case "info":
                            ...
                            base.settingPage.fnURI('/DMChucDanh/Create?viewMode=view&record=' + jQuery.fn.aesToParams(record.maDM));
                            base.settingPage.overlay = true;
                            break;
                        case "edit":
                            ...
                            base.settingPage.fnURI('/DMChucDanh/Create?viewMode=edit&record=' + jQuery.fn.aesToParams(record.maDM));
                            base.settingPage.overlay = true;
                            break;
                        default:
                            break;
                ...
                case "confirm":
                    Swal.fire({
                        title: 'Bạn có chắc chắn muốn xóa chức danh này?' + '</br> Bản ghi xóa: ' + record.maDM,
                        icon: 'warning',
    ...
    base.onCreate = function (target) {
        costJsBase.Post({
            Url: '/DMChucDanh/OnCreate', Data: {
                Record: $('#___record').val(),
                IsActive: $('#ddlStatuschucdanh option:selected').val(),
                MaDM: $('#txtmachucdanh').val(),
                TenDM: $('#txttenchucdanh').val(),
                Stt: $('#txtstt').val()
            },
            beforeSend: function () {
                costJsBase.ButtonState({
