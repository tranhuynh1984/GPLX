var DMPN = function () {
    ...
    base.$txtMaPhapNhan = $('#txtMaPhapNhan');
    base.$txtTenPhapNhan = $('#txtTenPhapNhan');
    base.$onLoad = true;
    ...
    base.pageLanguage = languages.vi.DMPN;
    ...
    base.searchForm = function (data) {
        if (typeof (data) !== 'undefined') {
            data.MaPhapNhan = base.$txtMaPhapNhan.val();
            data.TenPhapNhan = base.$txtTenPhapNhan.val();
            data.Status = $('#ddlStatus option:selected').val();
            base.setParamsAfterSearch(data);

            $('#txtMaPhapNhan').val($.trim(data.MaPhapNhan));
            $('#txtTenPhapNhan').val($.trim(data.TenPhapNhan));
        }
    }
    ...
    base.exportExcel = function() {
        ...
        costJsBase.ExportExcel('/DMPN/ExportExcel', data);
    }
