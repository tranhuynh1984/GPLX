var ManageDashboard = function () {
    ...
    base.$slWeek = $('#__searchWeekRequest');
        ...
        base.$tableDataTable = $.fn.jsTableRegister({
            ...
            columns: [
                ...
                },
                {
                    idx: 2,
                    render: function (data, type, row, meta) {
                        return moment(row.createdDate).year();
                    },
                    width: "5%",
                ...
                },
                {
                    idx: 10,
                    render: function (data, type, row, meta) {
                        let popupURL = '/CostEstimate/ViewHistories?record=' + jQuery.fn.aesToParams(row.record);
    ...
    base.bindActions = function () {
        ...
        base.$slWeek.select2({ theme: 'bootstrap4', width: '100%' }).change(function () {
            base.searching();
            base.ckcRecords = [];
        });
