var CreateDeXuatLuanChuyenMa = function () {
    let base = this;
        ...
        costJsBase.Post({
            ...
            if (data.code !== costJsBase.enums.successCode) {
                ...
                setTimeout(function () {
                    ...
                    window.location.href = '/DeXuat/CreateDeXuatLuanChuyenMa?DeXuat=' + $('#txtmadexuat').val();
                }, 1500);
            }
        }, function () {
            costJsBase.ButtonState({
    ...
    base.onCreateDXLuanChuyenMa = function (_tr) {

        costJsBase.PromissePost({
            Url: '/DeXuat/OnCreateDeXuatLuanChuyenMa',
            Data: {
                DeXuatCode: $('#txtmadexuat').val(),
    ...
    base.onRemoveDXLuanChuyenMa = function (_tr) {

        costJsBase.PromissePost({
            Url: '/DeXuat/OnRemoveDeXuatLuanChuyenMa',
            Data: {
                DeXuatCode: $('#txtmadexuat').val(),
                MaCTV: _tr.find('.lblCTV').val(),
...
$(document).ready(function () {
    let c = new CreateDeXuatLuanChuyenMa();
    c.Setup();
